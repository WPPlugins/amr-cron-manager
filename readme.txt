...
Overview of wp cron jobs in site's timezone. Shows action if it exists and any arguments to the cron job. Reschedule or delete cron jobs.

== Description ==

Overview of all cron jobs, showing whether the corresponding action is present.  If there is no action, nothing will happen.
